...
10. [Phase 8: 식사 관리 및 영양 추천 기능 구현](#10-phase-8-식사-관리-및-영양-추천-기능-구현)
...
우선순위를 **기능 완성도** 및 **사용자 가치** 기준으로 분류합니다.

| 우선순위 | 항목 | 이유 |
|----------|------|------|
| 🔴 **P0 (즉시)** | 기록 저장 버튼 실제 구현 | 핵심 UX — 저장이 안 되면 앱이 의미 없음 |
| 🔴 **P0 (즉시)** | 식사 미입력 시 알림(Nudge) | 사용자 건강 관리의 핵심 트리거 |
| 🔴 **P0 (즉시)** | 자연어 식사 데이터 파싱 (Gemini) | 편리한 입력을 통한 데이터 확보 |
| 🟠 **P1 (중요)** | 타임라인 식사 이벤트 표시 | 시계열 데이터 가시성 확보 |
| 🟠 **P1 (중요)** | 영양소 분석 및 식단 추천 | 사용자에게 실질적인 건강 가치 제공 |
